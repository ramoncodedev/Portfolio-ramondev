        ...
        <section className="relative py-24 md:py-32 bg-[#030303] overflow-hidden">
            <div className="container max-w-[1220px] w-full px-6 md:px-10 relative z-10 mx-auto">
                <motion.div
                     ...
                     props-variants={containerVariants}
                     initial="hidden"
                     whileInView="visible"
                ...
                >
                    ...
                    >
                         <div className="space-y-2 md:space-y-1">
                            <h2 className="text-white text-3xl md:text-[32px] font-semibold leading-tight md:leading-[42px]">
                                {title}
                            </h2>
                        </div>
                    ...
                    >
                        ...
                        {/* Main Mockup Card */}
                        <motion.div
                            className="relative w-full h-[405px] md:h-[600px] bg-[#ffffff0a] rounded-[32px] backdrop-blur-[15px] backdrop-brightness-[100%] z-10 overflow-hidden shadow-2xl shadow-black/50"
                            initial={{ y: reverseLayout ? 0 : 0 }}
                            whileInView={{ y: reverseLayout ? 20 : 30 }}
